...
window.STORY = {
  ...
  m24: {
    ...
    ende: "Vier Monate. Du hast die Nachricht gelesen, von der alles abhing — und du hast jedes Wort verstanden. Die letzte Zeile lautete: «Tu n'as plus besoin de nous.» Du brauchst uns nicht mehr. SAISON 4 ABGESCHLOSSEN. — Ein Jahr später vibriert in deiner Schublade ein Handy, das du längst weggelegt hattest."
  },

  m25: {
    intro: "Ein Jahr ist vergangen. Neue Klasse, neue Lehrerin, das alte Handy ganz unten in der Schublade. Und dann vibriert es doch.",
    beats: [
      "«Réponds vite. S'il te plaît.» Antworte schnell. Bitte. Von M, nach einem Jahr Funkstille.",
      "Du tippst zurück. Diesmal ohne den Umweg über die Übersetzung im Kopf. Die Wörter sind einfach da.",
      "«Tu écris beaucoup mieux qu'avant.» Du schreibst viel besser als früher. Es klingt fast erschrocken.",
      "«J'ai absolument besoin de quelqu'un en qui j'ai confiance.» Ich brauche unbedingt jemanden, dem ich vertraue."
    ],
    ende: "Und dann, nach einer langen Pause: «Il ne me reste que toi.» Mir bleibt nur noch du."
  },

  m26: {
    intro: "M schickt dir eine Datei und eine Anweisung. Wer sie bekommen soll, sagt er nicht — aber er sagt sehr genau, wer sie nicht bekommen darf.",
    beats: [
      "«Je te l'envoie maintenant.» Ich schicke sie dir jetzt. Zwei Pronomen in einem Satz, und du verstehst ihn, ohne nachzudenken.",
      "«Ne la leur donne pas.» Gib sie ihnen nicht. Die Reihenfolge der Wörter ist die ganze Anweisung.",
      "Du fragst: «Je la donne à qui, alors ?» — «À personne. Garde-la.» An niemanden. Behalt sie.",
      "Die Datei heißt 2247. Es ist die Nummer der Akte, die du vor einem Jahr gelesen hast."
    ],
    ende: "Du öffnest sie. Sie ist doppelt so lang wie damals. Jemand hat weitergeschrieben."
  },

  m27: {
    intro: "In der Akte steht, was du nie erfahren solltest. Und du kannst es inzwischen lesen.",
    beats: [
      ...
      "«C'est exactement ce dont j'avais peur.» Genau davor hatte ich Angst, schreibt M. Er hat die Akte selbst nie zu Ende gelesen.",
      "Du liest bis drei Uhr morgens. Tout ce que tu croyais savoir — alles, was du zu wissen glaubtest — stimmt nur zur Hälfte."
    ],
    ende: "Auf Seite 40 taucht ein Name auf, den du kennst. Es ist deiner. Der Eintrag ist drei Jahre alt."
  },

  m28: {
    intro: "Drei Jahre alt. Ein Jahr, bevor dir überhaupt jemand geschrieben hat.",
    beats: [
      ...
      "«J'avais essayé de te prévenir.» Ich hatte versucht, dich zu warnen. Die Brücke. Der Junge am Geländer. Vor einem Jahr.",
      "Du hörst dir die alte Aufnahme wieder an. Die drei Wörter am Ende, die du damals nicht verstanden hast. Jetzt verstehst du sie."
    ],
    ende: "«Ils ne t'ont pas trouvé. Ils t'avaient cherché.» Sie haben dich nicht gefunden. Sie hatten dich gesucht."
  },

  m29: {
    intro: "Die Frage, die dich seit der ersten Nacht begleitet, hat endlich eine Zeitform: Was wäre gewesen, wenn du damals nicht geantwortet hättest?",
    beats: [
      "«Si tu n'avais pas répondu, rien ne serait arrivé.» Hättest du nicht geantwortet, wäre nichts davon passiert.",
      "«Tu aurais pu dire non.» Du hättest nein sagen können. — «Toi aussi», tippst du zurück. Du auch.",
      "«J'aurais dû partir plus tôt.» Ich hätte früher gehen sollen. Zum ersten Mal klingt M einfach nur müde.",
      "«Mais alors, je ne t'aurais jamais connu.» Aber dann hätte ich dich nie kennengelernt."
    ],
    ende: "Dir fällt auf, dass du gerade in einer Zeitform denkst, die du vor einem Jahr nicht einmal lesen konntest."
  },

  m30: {
    intro: "Zum ersten Mal stellt M Forderungen. Und alle fangen gleich an.",
    beats: [
      "«Il faut que tu viennes.» Du musst kommen. Nicht «viens, s'il te plaît». Eine andere Form, ein anderer Ton.",
    ...
    ende: "Du schreibst: «Il faut que tu me dises où.» Er antwortet mit einer Adresse, die du auswendig kennst. Rue de Lille 47."
  },

  m31: {
    intro: "Du gehst los. Und merkst unterwegs, dass du zwei Dinge gleichzeitig tun kannst, für die du vor zwei Jahren hättest stehen bleiben müssen.",
    beats: [
      "«En arrivant, ne sonne pas.» Wenn du ankommst, klingel nicht.",
      "Du liest seine Nachrichten im Gehen. En marchant. Ohne anzuhalten, ohne nachzuschlagen.",
      "«J'essaie de tout t'expliquer», schreibt er. «Mais j'ai arrêté de mentir.» Ich versuche, dir alles zu erklären. Aber ich habe aufgehört zu lügen.",
      "Dritter Stock. Die Tür steht offen, genau wie beim ersten Mal. Nur weißt du diesmal, was das bedeutet."
    ],
    ende: "Jemand sitzt am Tisch. Es ist nicht M."
  },

  m32: {
    intro: "Letzte Akte. Was in diesem Zimmer passiert, steht morgen in der Zeitung — in Sätzen, in denen niemand vorkommt.",
    beats: [
      "«Le dossier a été publié ce matin.» Die Akte wurde heute Morgen veröffentlicht. Von wem, sagt der Satz nicht. Genau dafür gibt es das Passiv.",
      "Der Mann am Tisch sagt, M habe sich gestellt. «Il a dit qu'il était fatigué.» Er hat gesagt, er sei müde.",
      "«Il m'a demandé si tu comprenais.» Er hat mich gefragt, ob du verstehst. Du sagst ja. Und diesmal stimmt es.",
      "«On m'a dit que tu étais nul en français.» Man hat mir gesagt, du seist schlecht in Französisch. Der Mann sieht dich an. «On s'est trompé.» Man hat sich geirrt."
    ],
    ende: "Auf dem Tisch liegt ein letzter Umschlag. Darin ein Zettel, eine Zeile, M's Handschrift: «Ce n'était jamais une mission. C'était un cours de français. Et tu l'as terminé.» Es war nie eine Mission. Es war ein Französischkurs. Und du hast ihn zu Ende gebracht. AKTE GESCHLOSSEN."
  }
};
